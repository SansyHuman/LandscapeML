...
sci = SuperConformalIndex('t^2.172+t^3.104+2*t^3.828+t^4.345+t^4.552+t^5.276-2*t^6.+t^6.207+t^6.517-2*t^6.724+2*t^6.931+t^7.448+3*t^7.655-t^8.172+t^8.689-t^8.896-t^8.896/y^2-t^3.724/y-t^5.896/y+t^7.552/y-t^8.069/y+t^8.276/y-t^3.724*y-t^5.896*y+t^7.552*y-t^8.069*y+t^8.276*y-t^8.896*y^2')
print(f'Full index: {sci.index}')
print(f'Short index: {sci.short_index}')
print(f"Terms: {sci.terms_list}")
...
print(f'entire spectrum: {sci.spectrum}')
...
print(f'boson dimensions: {sci.boson_dims}')
print(f'boson spectrum: {sci.boson_spectrum}')
