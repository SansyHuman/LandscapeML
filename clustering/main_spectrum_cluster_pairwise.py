...
if __name__ == '__main__':
    ...
    def pair_calculation(theory1: str, theory2: str):
        ...
        for i in range(n_iter):
            if i == feature_impact_iter:
                acc_score, feature_impact = calculate_feature_importance(data_per_theory[theory1][i],
                                                                         data_per_theory[theory2][i])
    ...
    with open(f"{save_dir}/spectrum_cluster_pairwise_impact.csv", 'w', newline='') as csv_file:
        writer = csv.writer(csv_file)
    ...
    plt.savefig(f'{save_dir}/spectrum_cluster_pairwise_spectrum_impact.png')
    ...
    plt.savefig(f'{save_dir}/spectrum_cluster_pairwise_stat_impact.png')
