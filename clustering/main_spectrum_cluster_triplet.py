...
if __name__ == '__main__':
    ...
    with open(f"{save_dir}/spectrum_cluster_triplet_acc.csv", 'w', newline='') as csv_file:
    ...
    with open(f"{save_dir}/spectrum_cluster_triplet_stdev.csv", 'w', newline='') as csv_file:
        writer = csv.writer(csv_file)
        for i in range(n_theory):
            writer.writerow([theories[i]] + theories)
            for j in range(n_theory):
