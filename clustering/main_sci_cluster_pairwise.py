...
if __name__ == '__main__':
    ...
    with open(f"{save_dir}/sci_cluster_pairwise_impact.csv", 'w', newline='') as csv_file:
        writer = csv.writer(csv_file)
    ...
    plt.savefig(f'{save_dir}/sci_cluster_pairwise_spectrum_impact.png')
    ...
    plt.savefig(f'{save_dir}/sci_cluster_pairwise_stat_impact.png')
